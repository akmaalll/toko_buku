                                    ...
                                    <div class="dropdown-menu-content">
                                            ...
                                            <div class="row gx-2 justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    <img class="profile-image"
                                                        src="admin/assets/images/profiles/profile-1.png" alt="">
                                                </div><!--//col-->
                                                <div class="col">
                                                    <div class="info">
                                        ...
                                        <div class="item p-3">
                                            <div class="row gx-2 justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    <img class="profile-image"
                                                        src="admin/assets/images/profiles/profile-2.png"
                                                        alt="">
                                                </div><!--//col-->
                                                <div class="col">
                                                    <div class="info">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown"
                                    href="#" role="button" aria-expanded="false"><img
                                        src="admin/assets/images/user.png" alt="user profile"></a>
        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="{{ route('index') }}"><img class="logo-icon me-2"
                            src="admin/assets/images/app-logo.svg" alt="logo"><span
                            ...
                            <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a class="submenu-link"
                                            href="{{ route('index.buku') }}">Lihat Produk</a></li>
                                    <li class="submenu-item"><a class="submenu-link"
                                            href="{{ route('create.buku') }}">Tambah produk</a></li>
                                </ul>
                            </div>
                        </li><!--//nav-item-->
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a class="submenu-link"
                                            href="{{ route('datapelanggan') }}">Data Pelanggan</a></li>
                                </ul>
                            </div>
                        </li><!--//nav-item-->
                                ...
                                <div class="table-responsive">
                                    <table class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <tr>
                                                <th class="cell">id</th>
                                                <th class="cell">JudulBuku </th>
                                                <th class="cell">Pengarang</th>
                                        ...
                                        <tbody>
                                            @foreach ($bk as $v)
                                                <tr>
                                                    <td class="cell">{{ $no++ }}</td>
                                                    <td class="cell">{{ $v->judul }}</td>
                                                    <td class="cell">{{ $v->pengarang }}</td>
                                                    <td class="cell">{{ $v->stock }}</td>
                                                    <td class="cell">{{ $v->kategori }}</td>
                                                    <td class="cell">{{ $v->harga }}</td>
                                                    <td class="cell">
                                                        <a class="btn-sm app-btn-secondary"
                                                            href="buku/edit/{{ $v->id }}">Edit</a>
                                                        <a class="btn-sm app-btn-secondary" href="#">Hapus</a>
                                                    </td>
                                                </tr>
                                            @endforeach
