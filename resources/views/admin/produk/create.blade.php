    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Tambah Data Buku</h1>
                <hr class="mb-4">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="app-card app-card-settings shadow-sm p-4">
                            ...
                            <div class="app-card-body">
                                <form class="settings-form" action="{{ route('store.buku') }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        <label for="setting-input-2" class="form-label">Pengarang</label>
